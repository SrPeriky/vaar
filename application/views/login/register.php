                                ...
                                <form  autocomplete="off"  method="post" id="datos" enctype="multipart/form-data" onsubmit="guardar();return false;">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="departamento" name="departamento" class="form-control" aria-label="Default select example" onchange="selet(this.value, 'municipio', 'Municipio');">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="municipio" name="municipio" disabled="" class="form-control" aria-label="Default select example"  onchange="selet(this.value, 'institucion', 'Instituciòn');">
                                              <option value="" selected>Municipio</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Instituciòn</label>
                                            <select id="institucion" name="institucion" disabled="" class="form-control" aria-label="Default select example"  onchange="selet(this.value, 'direccion', 'Direcciòn');">
                                    ...
                                    <div class="p-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control " name="claveAdmin1" aria-describedby="emailHelp" placeholder="Clave">
                                        </div><div class="form-group">
                                            <label class="form-label">Clave</label>
                                            <input type="text" class="form-control " name="claveAdmin2" aria-describedby="emailHelp" placeholder="Repita la clave">
                                        </div>
                                        <div class="form-group">
                                        </div>
                                        <div class="row">
      ...
      var parametros = new FormData($('#datos')[0]);
        ...
        $.ajax({
            ...
            success: function(respuesta) {
              if(parseInt(respuesta.success)==5){
                $('#Modal').modal('hide');
                $('#Mbody').html('');
